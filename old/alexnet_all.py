...
class ContConv2d(nn.Module):
    def __init__(
        ...
        if self.QA_flag:
            self.quan = Quantization(
                quant_values=ac_quan_values,
                quan_bias=ac_quan_bias[count],
                init_beta=ac_init_beta,
            )
...
class AlexNet_Q(nn.Module):
    def __init__(
        ...
        if self.QA_flag:
            # print(self.count)
            self.quan0 = Quantization(
                quant_values=self.ac_quan_values,
                quan_bias=self.ac_quan_bias[self.count],
        ...
        self.features_2 = nn.Sequential(
            ContConv2d(
                256,
                384,
                ac_quan_values=self.ac_quan_values,
                ac_quan_bias=self.ac_quan_bias,
                ac_init_beta=self.ac_beta,
                count=2,
                kernel_size=3,
                stride=1,
                padding=1,
        ...
        if self.QA_flag:
            # print(self.count)
            self.quan2 = Quantization(
                quant_values=self.ac_quan_values,
                quan_bias=self.ac_quan_bias[4],
